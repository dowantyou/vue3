<template>
    <Transition name="fade">
        <div ref="containerRef" class="FooterBox sans" v-if="isContentVisible" @transition-end="handleTransitionEnd">
            <div class="lg:w-1/3">
                <a rel="noopener noreferrer" href="#" class="flex justify-center space-x-3 lg:justify-start">
                    ...
                    <span class="self-center text-2xl font-semibold">灵问词典</span>
                </a>
            </div>
            <div class="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                ...
                <div class="space-y-3  ml-3">
                    <div class="uppercase dark:text-gray-900">关 注 我 们 ！</div>
    ...
    <div class="text-center mt-2 sans">© 1968 Company Co. All rights reserved.</div>
    <!-- <br> -->
</template>
<script setup>
...
.FooterBox {
    @apply container flex flex-col justify-between mx-auto space-y-8 lg:flex-row lg:space-y-0;
    padding-top: 3.5rem;
